class Flowctl < Formula
  ...
  on_macos do
    resource "flowctl-binary" do
      url "{https://github.com/estuary/flow/releases/download}/v{0.3.4}/flowctl-multiarch-macos"
  ...
  on_linux do
    ...
    resource "flowctl-binary" do
      url "{https://github.com/estuary/flow/releases/download}/v{0.3.4}/flowctl-x86_64-linux"
